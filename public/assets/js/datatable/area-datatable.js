                            ...
                            return `
                                <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a class="dropdown-item" href="/area/${data}"><i class="ti ti-eye me-2"></i>View</a>
                                        ...
                                        <a class="dropdown-item delete-area" href="javascript:void(0);" data-id="${data}"><i class="ti ti-trash me-2"></i>Delete</a>
                                    </div>
                                </div>
                            `;
                        }
